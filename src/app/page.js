...
try {
  ...
  //  console.log(day); // Output: შაბათი 17 აგვისტო
} catch (error) {
...
export default async function HomePage() {
  ...
  function todayText(todayText, data) {
    var counter = [];
    for (let i = 0; i < data.length; i++) {
    ...
    <div className="container">
      <div className="row">
        <div className="col-xl-3 col-lg-4 col-md-4 bgcolor-left">
          <div className="cityName">თბილისი</div>
          ...
          <div className="col-12 d-flex justify-content-center">
            <div className="icon-main">
              <Image width={128} height={128} src={`/${weatherData.days[0].icon}.png`} alt="rain" />
            </div>
          ...
          <div className="col-12">
            <div className="col-12 d-flex w-100 justify-content-between">
              <div className="col-6 ">
                <Link
                  ...
                  href={`tbilisi/30-dgis-amindis-prognozi`}>
                  30 დღის
                </Link>
              </div>
              <div className="col-6 ">
                <Link
                  className="day-details btn btn-primary"
                  href={`tbilisi/25-dgis-amindis-prognozi`}>
                  25 დღის
                </Link>
              </div>
            </div>
            <div className="col-12 d-flex w-100 justify-content-between mt-3">
              <div className="col-6 ">
                <Link
                  className="day-details btn btn-primary "
                  href={`tbilisi/16-dgis-amindis-prognozi`}>
                  16 დღის
                </Link>
              </div>
              <div className="col-6 ">
                <Link
                  className="day-details btn btn-primary "
                  href={`tbilisi/12-dgis-amindis-prognozi`}>
                  12 დღის
                </Link>
              </div>
            </div>
            <div className="col-12 d-flex w-100 justify-content-between mt-3">
              <div className="col-12 ">
                <Link
                  ...
                  href={`tbilisi/7-dgis-amindis-prognozi`}>
                  7 დღის
                </Link>
              </div>
            </div>
              ...
              <div className="left-menu__speed d-flex">
                ...
                <div className="left-menu__wheaterInfo">
                  ...
                  <div className="left-menu__wheatewneva d-flex">
                    ...
                    <div className="col-12 mt-1 ms-1 ">
                      <div className="wneva-text wneva-text2 ">ქარის სიჩქარე</div>
                      <div className="col-12 wneva-text3">
